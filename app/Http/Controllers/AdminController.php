...
class AdminController extends Controller
{
    ...
    public function store(StoreAdminRequest $request)
    {
        ...
        $admin = Admin::create([
            ...
            'password'  => $plainPassword, // Le mutator va hasher automatiquement
        ]);

        return response()->json([
            'message' => 'Admin créé avec succès !',
            'data'    => new AdminResource($admin),
            'generated_password' => $plainPassword, // Retourner le mot de passe en clair généré pour que l'admin puisse se connecter
        ], 201);
    }
}
